...
A significant alternative explanation for the declining YTR is differential platform migration by age. During 2018 to 2025, younger Korean internet users increasingly migrated aesthetic information-seeking from Naver to Google, YouTube, Instagram, and TikTok [22,23]. If younger users preferentially left the Naver search ecosystem, their search interest would be undercounted while the traditional demographic — which has higher Naver platform loyalty — would appear to grow relatively faster. Our platform migration sensitivity analysis provides quantitative bounds on this confound: even under the assumption that 7% of young Naver users migrated to other platforms annually (cumulative 1.84× correction by 2025), thread lifting and generic lifting retained significant maturation signals, while HIFU-value became nonsignificant at 5% attrition. This suggests that the maturation finding for the strongest-signal keywords reflects genuine demographic dynamics, not solely platform migration, though the two contributions cannot be fully disaggregated. Naver remains the dominant platform for clinic-related commercial searches in South Korea [16], and the age shift in Naver search behavior directly reflects the age shift in the patient population that clinics encounter through search-driven patient acquisition.
...
Several limitations should be considered. First, and most importantly, differential platform migration by age represents a significant confound. Younger Koreans have increasingly adopted Google, YouTube, Instagram, and TikTok for aesthetic information, while older users maintain higher Naver loyalty. Our scenario-based sensitivity analysis demonstrated that the maturation finding for the 2 strongest keywords (thread lifting, generic lifting) was robust to assumed young-user attrition rates up to 7% per year, but the finding for HIFU-value (슈링크) became nonsignificant at 5% attrition. The observed maturation pattern likely reflects a combination of genuine market dynamics and platform-specific demographic shifts, and their precise contributions cannot be fully disaggregated. Second, Naver RSV is independently normalized within each query's age parameter, meaning that the proportional share analysis (Approach B) relies on an assumption of comparable RSV scaling across age groups; Approach A addresses this by comparing within-age temporal trends. Third, search interest does not equate to procedure uptake: searching does not confirm that the person underwent the procedure. However, prior infodemiology studies have demonstrated moderate-to-strong correlations between Google Trends RSV and actual healthcare utilization volumes for aesthetic procedures [10,12], and Naver search behavior directly feeds the clinic-patient acquisition pathway in Korea, where the majority of aesthetic consultations originate from online searches [16]. Our findings regarding age-demographic shifts in search behavior thus have direct clinical relevance even as a proxy measure. Fourth, keywords may not capture all relevant search behavior, including social media searches and clinic-specific terminology. Fifth, single-country primary data limit direct generalizability. However, South Korea ranks among the top 5 countries globally for per-capita aesthetic procedure volume [1], originated several of the devices studied (Shrink, InMode), and has the most mature non-surgical lifting market in Asia — making it a leading indicator for trends that may subsequently appear in other markets. Sixth, the study cannot distinguish patient-searchers from information-seekers such as journalists, students, or practitioners. Finally, the innovation diffusion framework assumes that non-surgical lifting was relatively novel in 2016; in practice, Thermage and Ulthera were already established, and the early-adopter framing may apply primarily to newer entrants.
